...
import "@/scss/components/resurse.scss";
import MathJaxRender from "@/components/MathJaxRender";
import './scss/style.scss';
import Video1 from "../public/res/Videos/Pendul Video.mp4";
import Video2 from "../public/res/Videos/Frecventa Undelor Video.mp4";
import Video3 from "../public/res/Videos/Unde Videoclip.mp4";
import Video4 from "../public/res/Videos/Front Unda 1.mp4";
import Video5 from "../public/res/Videos/Front Unda 2.mp4";
import Video6 from "../public/res/Videos/Lissajous-Video-1.mp4";
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-10">
        ...
        <Tabs defaultValue="formule" className="max-w-4xl mx-auto">
            ...
            <div className="rounded-container">
              ...
              <div className="formula-grid">
                <div className="formula-card">
                  ...
                  <a href="/Simulari/pendule" className="resurse-link">Citește lecția</a>
                </div>
                <div className="formula-card">
                  ...
                  <a href="/Simulari/unde" className="resurse-link">Citește lecția</a>
                </div>
                <div className="formula-card">
                  ...
                  <a href="/Simulari/lissajous" className="resurse-link">Citește lecția</a>
                </div>
                <div className="formula-card">
                  ...
                  <a href="/Simulari/seism" className="resurse-link">Citește lecția</a>
                </div>
              </div>
            </div>
          </TabsContent>
